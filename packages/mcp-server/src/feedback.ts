...
export const FEEDBACK_ASK_TEXT = [
	...
	"you send it in — Andy updates Claudback pronto.\" If they share feedback in the chat,",
	"draft it into the feedback form (https://github.com/andybiggs/claudback/issues/new/choose)",
	"for them to review and submit — comments never leave their machine on their own.",
