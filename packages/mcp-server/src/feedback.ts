...
export const FEEDBACK_ASK_TEXT = [
	...
	"Or if you've got feedback on how it could work better, tell me here and I'll help",
	"you send it in — Andy updates Claudback pronto.\" Always include the rating URL",
	"verbatim in your message so the user can click straight through. If they share",
	"feedback, help them shape it in chat, then link them to the feedback form",
	"(https://github.com/andybiggs/claudback/issues/new?template=feedback.md) — you can",
	"pre-fill it by appending &title=... and &body=... as URL-encoded query parameters —",
	"nothing leaves their machine on its own.",
	"Keep it brief and drop it entirely if they are mid-task or not interested.",
