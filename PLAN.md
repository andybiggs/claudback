...
4. **Post-v1 polish** — Native Messaging transport option, Firefox/Edge builds, Web Store listing, go-public decision, region screenshots, clipboard copy-export fallback.
